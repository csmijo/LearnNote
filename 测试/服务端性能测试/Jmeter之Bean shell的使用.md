...
* `BeanShell` **是用Java写成的**,一个小型的、免费的、可以下载的、嵌入式的`Java`源代码解释器,具有对象脚本语言特性，非常精简的解释器`jar`文件大小为175k。
...
* 更多的方法可以查看官方文档：http://jmeter.apache.org/api/org/apache/jmeter/ 
...
3. 创建 BeanShell PreProcessor 生成随机 uid
   ...
   ![2017-06-20_193742.PNG](http://on9czqsf5.bkt.clouddn.com/2017-06-20_193742.PNG?2017-06-20-19-38-03)
